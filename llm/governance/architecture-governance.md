...
(`llm/governance/governance-levels.md` is the source of truth for merge
...
| Review | Reviewer | Reviewer applies `llm/governance/review-checklist.md` to L1–L3 work. |
...
work (`llm/governance/definition-of-done.md`), completed before the PR is
marked ready. No AI role merges its own work — the only exception is the
Repository Steward on certified, independently audited L0 PRs in repos that
have activated the fast track (`llm/governance/l0-fast-track.md`).
