<!--
Template for an adopting repo's .github/pull_request_template.md.
Install via /governance:establish. Replace agentic-governance doc
references with however the repo reaches the canonical docs (path or URL),
keeping the delta as the local entry point.
-->
